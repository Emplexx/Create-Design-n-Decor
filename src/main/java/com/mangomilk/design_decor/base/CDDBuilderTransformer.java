...
import static com.mangomilk.design_decor.registry.CDDBlocks.BB;
...
public class CDDBuilderTransformer {
    ...
    public static BlockEntry<ConnectedTintedGlassBlock> tintedframedGlass(Supplier<ConnectedTextureBehaviour> behaviour) {
        return DesignDecor.REGISTRATE.block("tinted_framed_glass", ConnectedTintedGlassBlock::new)
                ...
                .recipe((c, p) -> p.stonecutting(DataIngredient.tag(Tags.Items.GLASS_TINTED), BB, c::get))
    ...
    public static BlockEntry<Block> CastelBricks(String id, String lang, MapColor color, Block block) {
        DesignDecor.REGISTRATE.block(id + "_castel_brick_stairs", p -> new StairBlock(block.defaultBlockState(), p))
                ...
                .recipe((c, p) -> p.stonecutting(DataIngredient.tag(CreateItemTag("stone_types/" + id)), BB, c::get, 1))
        ...
        DesignDecor.REGISTRATE.block(id + "_castel_brick_slab", SlabBlock::new)
                ...
                .recipe((c, p) -> p.stonecutting(DataIngredient.tag(CreateItemTag("stone_types/" + id)), BB, c::get, 2))
